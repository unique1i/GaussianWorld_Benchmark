...
def main():
    ...
    argparser.add_argument("--save_pred", action="store_true", help="Save predictions for all coord as <scene_id>_<benchmark>_semseg_pred.npy")
    argparser.add_argument("--model_name", type=str, default="clip", choices=["clip", "siglip2"])
    ...
    langfeat_root = args.langfeat_root or         "/home/yli7/scratch/datasets/gaussian_world/outputs/ludvig/matterport3d"
