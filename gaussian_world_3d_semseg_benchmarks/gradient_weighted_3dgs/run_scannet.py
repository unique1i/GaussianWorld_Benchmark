...
def get_arguments():
    ...
    parser.add_argument('--split', type=str, default='/insait/qimaqi/workspace/3dgs-gradient-backprojection-benchmark/splits/scannet_mini_val.txt', help='Split name')
...
if __name__ == "__main__":
    ...
    for scene in validation_set:
        ...
        if args.rescale == 0:
            ...
            potential_results_dir = os.path.join(result_root, scene,  'features_lseg_320_480.pt')
        ...
        os.system("python backproject_ply_scannet.py --data_root_path {} --ply_root_path {} --results_root_dir {} \
