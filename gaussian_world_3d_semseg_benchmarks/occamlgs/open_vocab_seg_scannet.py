...
def main():
    ...
    model_name = "clip"
    val_split_path = args.val_split_path or "/home/yli7/projects/yue/language_feat_exps/splits/scannet_val.txt" 
    scannet_preprocessed_root = args.scannet_preprocessed_root or "/home/yli7/scratch2/datasets/ptv3_preprocessed/scannet_preprocessed"
    scannet_3dgs_root = args.scannet_3dgs_root or "/home/yli7/scratch2/datasets/gaussian_world/scannet_mcmc_3dgs" # scannet_default_fix_xyz_gs, scannet_mcmc_3dgs
    scannet_langfeat_root = os.path.join(scannet_3dgs_root, f"language_features_{model_name}") # language_features_siglip2, language_features_instance
    ...
    for scene_id in tqdm(scene_ids, desc="Processing scenes"):
        ...
        if not os.path.exists(scene_folder):
            raise ValueError(f"Scene {scene_id} not found in {scannet_preprocessed_root}")
        ...
        gs_path = os.path.join(scannet_3dgs_root, scene_id, "ckpts", "point_cloud_30000.ply")
        ...
        elif os.path.exists(os.path.join(scannet_langfeat_root, scene_id, "langfeat.npy")):
            gauss_lang_feat = np.load(os.path.join(scannet_langfeat_root, scene_id, "langfeat.npy"))
