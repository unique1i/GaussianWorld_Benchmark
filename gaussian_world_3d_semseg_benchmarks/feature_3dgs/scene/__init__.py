...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]): 
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
        ...
        elif os.path.exists(os.path.join(args.source_path, "transforms_train.json")) and (not os.path.exists(os.path.join(args.source_path, "lang_feat_selected_imgs.json"))):
            ...
            print("semantic_feature_dim", scene_info.semantic_feature_dim)
        elif os.path.exists(os.path.join(args.source_path, "lang_feat_selected_imgs.json")) and 'scannet' in args.source_path:
            print("Found lang_feat_selected_imgs.json file, assuming ScanNet data set!")
            scene_info = sceneLoadTypeCallbacks["ScanNet"](args.source_path, args.foundation_model, args.white_background, args.eval)
        elif os.path.exists(os.path.join(args.source_path, "lang_feat_selected_imgs.json")) and 'matterport' in args.source_path:
            print("Found lang_feat_selected_imgs.json file, assuming Matterport data set!")
            scene_info = sceneLoadTypeCallbacks["Matterport"](args.source_path, args.foundation_model, args.white_background, args.eval)
        elif os.path.exists(os.path.join(args.source_path, "lang_feat_selected_imgs.json")) and 'holicity' in args.source_path:
            print("Found lang_feat_selected_imgs.json file, assuming Matterport data set!")
            scene_info = sceneLoadTypeCallbacks["Holicity"](args.source_path, args.foundation_model, args.white_background, args.eval, all_cams=True)
