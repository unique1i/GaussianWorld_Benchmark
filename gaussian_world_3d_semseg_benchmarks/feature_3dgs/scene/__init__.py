...
class Scene:
    ...
    def __init__(
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            os.path.join(args.source_path, "scans", "mesh_aligned_0.05.ply")
        ):
            ...
            and "scannet" in args.source_path
        ):
            ...
            and "matterport" in args.source_path
        ):
            print(
                "Found lang_feat_selected_imgs.json file, assuming Matterport data set!"
            )
            scene_info = sceneLoadTypeCallbacks["Matterport"](
                args.source_path,
                args.foundation_model,
                args.white_background,
                args.eval,
