...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, ply_path, debug_from):
    first_iter = 0
    ...
    if ply_path:
        gaussians.load_gs_ply_only(ply_path, semantic_feature_size=512, speedup=dataset.speedup)
        first_iter = 0
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        # print("RGB Ll1", Ll1.item(), "Ll1_feature", Ll1_feature.item())
