    ...
    for scene_name in scene_ids:
        for split in [
            ...
            print(
                ...
                "in",
                os.path.join(
                    feature_3dgs_path, split, f"ours_{iteration}", test_feat_name
                ),
            )
            assert (
                len(feat_files) > 0
            ), f"No feature files found in {os.path.join(feature_3dgs_path, split, f'ours_{iteration}', test_feat_name)}"
