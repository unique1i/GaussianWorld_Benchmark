...
from data import get_original_dataset_pp
...
if __name__ == "__main__":
    ...
    for val_i in val_split_10_scene:
        # print("val_i", val_i)
        args.test_rgb_dir = os.path.join(
            data_root_path, val_i, "dslr", "undistorted_images"
        )
        ...
        args.selected_frames_path = os.path.join(
            data_root_path, val_i, "dslr", "nerfstudio", "lang_feat_selected_imgs.json"
        )
