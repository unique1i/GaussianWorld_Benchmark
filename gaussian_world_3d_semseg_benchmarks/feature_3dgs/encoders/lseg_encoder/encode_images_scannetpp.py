...
from data import get_dataset, get_original_dataset_pp
...
def test(args):
    ...
    # testset = get_dataset(
    testset = get_original_dataset_pp(
        ...
        selected_frames=selected_imgs_list ,
    )
...
if __name__ == "__main__":
    ...
    data_root_path = '/usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/GS_Transformer/data/scannet_full/data/'
    val_split = np.loadtxt(split_path, dtype=str)
    # print("val_split", val_split)
    val_split = sorted(val_split)

    # python -u encode_images.py --backbone clip_vitl16_384 --weights demo_e200.ckpt --widehead --no-scaleinv --outdir /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/GS_Transformer/data/scannet_full/data/09c1414f1b/dslr/feature_3dgs/rgb_feature_langseg --test-rgb-dir /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/GS_Transformer/data/scannet_full/data/09c1414f1b/dslr/undistorted_images --workers 0
    ...
    for val_i in val_split_10_scene:
        #print("val_i", val_i)
        args.test_rgb_dir = os.path.join(data_root_path, val_i, "dslr", "undistorted_images")
        args.outdir = os.path.join('/srv/beegfs02/scratch/qimaqi_data/data/scannet_full/data', val_i, "rgb_feature_langseg")
        args.selected_frames_path = os.path.join(data_root_path, val_i, "dslr", "nerfstudio" ,"lang_feat_selected_imgs.json")
        #print("args.test_rgb_dir", args.test_rgb_dir)
