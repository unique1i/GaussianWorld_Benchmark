...
if __name__ == "__main__":
    ...
    subset_path = '/srv/beegfs02/scratch/qimaqi_data/data/scannet_subset/subset_sequences'
    ...
    val_split_10_scene = ['scene0153_01']
    for val_i in val_split_10_scene:
        #print("val_i", val_i)
        args.test_rgb_dir = os.path.join(data_root_path, val_i, "color_interval")
