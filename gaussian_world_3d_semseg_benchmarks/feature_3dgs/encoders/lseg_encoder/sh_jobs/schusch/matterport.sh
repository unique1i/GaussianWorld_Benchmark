...
python -u encode_images_matterport.py --backbone clip_vitl16_384 --weights demo_e200.ckpt --widehead --no-scaleinv --outdir /srv/beegfs02/scratch/qimaqi_data/data/scannet_full/data --test-rgb-dir /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/GS_Transformer/data/scannet_full/data/09c1414f1b/dslr/undistorted_images --workers 0
