...
if __name__ == "__main__":
    ...
    subset_path = '/srv/beegfs02/scratch/qimaqi_data/data/matterport_subset'
    data_root_path = subset_path
    ...
    val_split_10_scene = os.listdir(subset_path)

    # check if it is folder
    val_split_10_scene = [val_i for val_i in val_split_10_scene if os.path.isdir(os.path.join(subset_path, val_i))]

    for val_i in val_split_10_scene:
        #print("val_i", val_i)
        args.test_rgb_dir = os.path.join(data_root_path, val_i, "images")
