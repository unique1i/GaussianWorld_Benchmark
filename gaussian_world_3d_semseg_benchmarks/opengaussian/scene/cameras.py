...
class Camera(nn.Module):
    def __init__(
        ...
        # modify -----
        self.original_mask = (
            gt_alpha_mask.to(self.data_device) if gt_alpha_mask is not None else None
        )

        # modify -----
        self.original_sam_mask = (
            gt_sam_mask.to(self.data_device) if gt_sam_mask is not None else None
        )
        self.original_mask_feat = (
            gt_mask_feat.to(self.data_device) if gt_mask_feat is not None else None
        )
