...
def main():
    ...
    argparser.add_argument("--pred_scene_dir", type=str, default="/scratch/joanna_cheng/holicity_pred")
    ...
    log_path = f"logs/{method_name}_{gs_folder_name}_nn_num_{nn_num}_holicity_{model_name}.txt"
