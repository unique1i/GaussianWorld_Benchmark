...
def training(
    ...
    if ply_path:
        gaussians.restore_ply(ply_path, opt)
        first_iter = 0
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        #     print("feature loss", Ll1.item())
        #     gt_image = viewpoint_cam.original_image.cuda()
        #     Ll1 = l1_loss(image, gt_image)
        #     print("debug L1 loss", Ll1.item())
        ...
        #     print("Save render image and gt image to", "./{}_render_image_{}.png".format(source_name, iteration))
