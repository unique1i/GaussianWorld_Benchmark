...
class GaussianModel:
    ...
    def restore(self, model_args, training_args, mode="train"):
        ...
        print(
            "self.max_radii2D",
            self.max_radii2D.shape,
            self.max_radii2D.min(),
            self.max_radii2D.max(),
        )
        print(
            "xyz_gradient_accum",
            xyz_gradient_accum.shape,
            xyz_gradient_accum.min(),
            xyz_gradient_accum.max(),
        )
        print("denom", denom.shape, denom.min(), denom.max())
    ...
    def restore_ply(self, path, training_args):
