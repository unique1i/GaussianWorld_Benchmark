        ...
        if args.dataset_name == "scannet":
            ...
            if os.path.exists(os.path.join(args.dataset_folder, "scans", scene_id)):
                dataset_path = os.path.join(
                    args.dataset_folder, "scans", scene_id)
            elif os.path.exists(os.path.join(args.dataset_folder, "scans_test", scene_id)):
                dataset_path = os.path.join(
                    args.dataset_folder, "scans_test", scene_id)
            else:
            ...
            cmd = [
                ...
                dataset_path,
                "--save_folder",
                args.save_folder if args.save_folder else os.path.join(
                    args.dataset_folder, "language_features"),
                "--zipped"
            ]
            ...
            cmd = [
                ...
                "--save_folder",
                args.save_folder if args.save_folder else os.path.join(
                    args.dataset_folder, "language_features_siglip2"),
                "--resolution",
