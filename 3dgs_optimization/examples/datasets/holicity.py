...
class HoliCityDataset(Dataset):
    def __init__(
        ...
        self.image_zip = None
        self.depth_zip = None
        self.depth_scale = 100  # Depth scale factor for Holicity
    ...
    def _load_depth(self, depth_rel_path: str, zipped: bool) -> torch.Tensor:
        ...
        depth_np = load_npz_first(depth_path).astype(np.float32)
        depth_np = depth_np / self.depth_scale  # 100 for Holicity
